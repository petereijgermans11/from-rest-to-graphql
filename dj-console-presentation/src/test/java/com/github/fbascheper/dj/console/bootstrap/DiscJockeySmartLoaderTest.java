...
class DiscJockeySmartLoaderTest {
    ...
    void start_registersDiscJockeyWithPopulatedTrackLibrary() {
        ...
        var sampleTrack = TrackTestObjects.TRACK_RADAR_LOVE.getInstance();
        ...
        var djOpt = registry.findByName("DJ Laurens");
        assertThat(djOpt).as("DJ Laurens must be registered").isPresent();
